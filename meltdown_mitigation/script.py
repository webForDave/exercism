...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    temperature_and_neutrons = temperature * neutrons_produced_per_second
    ten_percent_treshold = threshold * 0.1
    upper_bound = threshold + ten_percent_treshold
    lower_bound = threshold - ten_percent_treshold

    if temperature_and_neutrons < (threshold * 0.9):
        return "LOW"
    if lower_bound <= temperature_and_neutrons <= upper_bound:
        return "NORMAL"
