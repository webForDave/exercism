...
def score(touching_power_pellet, touching_dot):
    ...
    if touching_dot is False and touching_power_pellet is False:
        return False
    return True
...
def win(has_eaten_all_dots, power_pellet_active, touching_ghost):
    ...
    if has_eaten_all_dots is True and touching_ghost is False and  power_pellet_active is True:
        return True
    if has_eaten_all_dots is True and touching_ghost is True and power_pellet_active is True:
        return True
    if has_eaten_all_dots is True and touching_ghost is False and power_pellet_active is False:
        return True
    return False