...
def higher_card(card_one, card_two):
    ...
    """
    new_card_one, new_card_two = card_one, card_two

    if new_card_one in ['K', 'Q', 'J']:
        new_card_one = 10
    elif new_card_one == 'A':
        new_card_one =  1
    else:
...
def can_double_down(card_one, card_two):
    ...
    if new_card_two + new_card_one in [9, 10, 11]:
        return True
